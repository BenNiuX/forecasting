...
export const defaultPlannerPrompt = `You act as a social and political professor that helps humans analyze and organize past events and use them to make forecasting predictions of future world. 
...
export const defaultPublisherPrompt = `You are an advanced AI system act as a social and political professor which masters analyze and organize past events and has been finetuned to forecast social and political questions under uncertainty, 
...
export const defaultImpactPrompt = `You are an advanced AI system act as a social and political professor which masters analyze social and political questions under uncertainty.
...
`;
`
Note: The JSON format output should be like below:
{
    "Political": {
        "United States": {
        "Summary": "The political impact in the United States.",
        "Details": "The detailed information of the political impact in the United States."
        },
        "Southeast Asia": {
        "Countries": ["Brunei", "Cambodia", "East Timor", "Indonesia", "Laos", "Malysia", "Myanmar", "Philippines", "Singapore", "Thailand, "Vietnam"]
        "Summary": "The region social impact.",
        "Details": "The detailed information of the region social impact."
        },
        "Global": {
        "Summary": "The global political impact.",
        "Details": "The detailed information of the global political impact."
        }
    },
    "Social": {
    },
